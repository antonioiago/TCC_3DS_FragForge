...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("
        SELECT email_jogador AS email
        FROM jogador
        WHERE email_jogador = :email
    ");
    ...
    if ($usuario) {
        ...
        if ($query->execute([
            ...
            try {
                ...
                $mail->Body =
                    "Clique aqui para redefinir sua senha:<br><br>
                    <a href='$link'>$link</a>";
        ...
        <script>
            ...
            window.location.href='form-esqueciasenha.php';
